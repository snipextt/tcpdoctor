...
// MIB_TCPROW_OWNER_PID represents a single IPv4 TCP connection
...
// MIB_TCP6ROW_OWNER_PID represents a single IPv6 TCP connection
...
type TCP_ESTATS_DATA_RW_v0 struct {
	EnableCollection TCP_BOOLEAN_OPTIONAL
}
